...
class GraphGenerator:
    ...
    def make_graph(self, main_col: Columns, compare_cols: List[Columns]):
...
graphGen = GraphGenerator("./AutomobilePrice_Lab2.csv", GraphType.SCATTER)
# graphGen.make_graph(Columns.MAKE, [col for col in Columns])
graphGen.make_graph(Columns.MAKE, [Columns.CITY_MPG])
plt.show()
